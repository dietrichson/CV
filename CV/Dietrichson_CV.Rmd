...
research_appointments <- 
  ...
  "Visiting Researcher","2003-2005","Keyo University","Tokyo, Japan","Worked on research based curriculum design for online courses in Academic English.",
...
```{r}
bibliography_entries("./dietrichson_bibliography.bib", title="Selected Papers and Presentations")
```
